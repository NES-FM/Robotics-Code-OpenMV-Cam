...
class I2C:
    ...
    def mem_read(self, data: Union[int, bytearray], addr: int, memaddr: int, timeout: Optional[int], addr_size: Optional[int]) -> bytearray: """Read from the memory of an I2C device:
    ...
    def mem_write(self, data: Union[int, bytearray], addr: int, memaddr: int, timeout: Optional[int], addr_size: Optional[int]) -> None: """Write to the memory of an I2C device:
    ...
    def recv(self, recv: Union[int, bytearray], addr: Optional[int], timeout: Optional[int]) -> bytearray: """Receive data on the bus:
    ...
    def send(self, send: Union[int, bytearray], addr: Optional[int], timeout: Optional[int]) -> None: """Send data on the bus:
